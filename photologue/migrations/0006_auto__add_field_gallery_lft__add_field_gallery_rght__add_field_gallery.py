...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Gallery.lft'
        db.add_column('photologue_gallery', 'lft', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'Gallery.rght'
        db.add_column('photologue_gallery', 'rght', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'Gallery.tree_id'
        db.add_column('photologue_gallery', 'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'Gallery.level'
        db.add_column('photologue_gallery', 'level', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Changing field 'Gallery.parent'
        db.alter_column('photologue_gallery', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['photologue.Gallery']))


    def backwards(self, orm):
        
        # Deleting field 'Gallery.lft'
        db.delete_column('photologue_gallery', 'lft')

        # Deleting field 'Gallery.rght'
        db.delete_column('photologue_gallery', 'rght')

        # Deleting field 'Gallery.tree_id'
        db.delete_column('photologue_gallery', 'tree_id')

        # Deleting field 'Gallery.level'
        db.delete_column('photologue_gallery', 'level')

        # Changing field 'Gallery.parent'
        db.alter_column('photologue_gallery', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photologue.Gallery'], null=True))
