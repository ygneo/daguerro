...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Photo.family'
        db.delete_column('photologue_photo', 'family')

        # Deleting field 'Photo.alternative_title_url'
        db.delete_column('photologue_photo', 'alternative_title_url')

        # Deleting field 'Photo.alternative_title'
        db.delete_column('photologue_photo', 'alternative_title')


    def backwards(self, orm):
        
        # Adding field 'Photo.family'
        db.add_column('photologue_photo', 'family', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Photo.alternative_title_url'
        db.add_column('photologue_photo', 'alternative_title_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Photo.alternative_title'
        db.add_column('photologue_photo', 'alternative_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'photologue.gallery': {
            ...
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'gallery_photo'", 'null': 'True', 'to': "orm['photologue.Photo']"}),
