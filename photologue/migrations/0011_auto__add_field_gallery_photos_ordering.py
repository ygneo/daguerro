...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gallery.photos_ordering'
        db.add_column('photologue_gallery', 'photos_ordering',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gallery.photos_ordering'
        db.delete_column('photologue_gallery', 'photos_ordering')
