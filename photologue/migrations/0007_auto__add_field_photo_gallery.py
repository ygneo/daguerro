...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('photologue_photo', 'gallery', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photo_set', null=True, to=orm['photologue.Gallery']), keep_default=False)
    ...
    models = {
        ...
        'photologue.photo': {
            ...
            'gallery': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photo_set'", 'null': 'True', 'to': "orm['photologue.Gallery']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
