...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('photologue_photo', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)

        # Adding field 'Photo.longitude'
        db.add_column('photologue_photo', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.latitude'
        db.delete_column('photologue_photo', 'latitude')

        # Deleting field 'Photo.longitude'
        db.delete_column('photologue_photo', 'longitude')
