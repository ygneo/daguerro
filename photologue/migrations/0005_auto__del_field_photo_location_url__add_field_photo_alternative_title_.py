...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Photo.location_url'
        db.delete_column('photologue_photo', 'location_url')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Photo.location_url'
        db.add_column('photologue_photo', 'location_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)
    ...
    models = {
        'photologue.gallery': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['photologue.Gallery']", 'null': 'True', 'blank': 'True'}),
        ...
        'photologue.photo': {
            ...
            'alternative_title': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'alternative_title_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'caption': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
