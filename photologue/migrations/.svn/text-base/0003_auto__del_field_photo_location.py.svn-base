...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('photologue_photo', 'location')


    def backwards(self, orm):
        
        # Adding field 'Photo.location'
        db.add_column('photologue_photo', 'location', self.gf('photologue.widgets.LocationField')(default='', max_length=255, blank=True), keep_default=False)
